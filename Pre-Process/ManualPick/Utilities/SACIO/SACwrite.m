function SACwrite( sac_st, filename_sac )
%%  A Matlab function to write sac file
%   Write a binary sac file based on a sac_st structure.
%--------------------------------------------------------------------------
% Input:
%   sac_st: sac structure;
%   filename_sac: output sac file name;
%--------------------------------------------------------------------------
...
if strcmp(endian,'B')
    fid = fopen(filename_sac,'w','ieee-be'); 
elseif strcmp(endian,'L')
    fid = fopen(filename_sac,'w','ieee-le'); 
end
...
msg_id = 'writesac_ayu:ParaIncomplete';
