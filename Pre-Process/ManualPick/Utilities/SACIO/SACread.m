function [ sac_st ] = SACread( filename_sac )
%%  A Matlab function to read sac file
%   Reading a sac file and save it as a sac_st structure, which with
%   sac_st.(header_element) and sac_st.data
%% Basic Information---------------------------------------------
% Input:
%   filename_sac: input sac file name
%--------------------------------------------------------------------------
% Output
...
fid_lil = fopen(filename_sac,'r','ieee-le'); 
fid_big = fopen(filename_sac,'r','ieee-be');
