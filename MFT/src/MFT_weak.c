...
void warnfunc()
{
	cout << "Usage: ./MFT_weak [tpname] [tptime] [tpsac dir] [tp arrival time list] "
		 << "[tpcutb] [tpcute] [time of scan start] [time of scan end] [nsigma] [list of sac file for scan]"
		 <<endl;
	cout << "       ./MFT_weak [tpname] [tptime] [tpsac dir] [tp arrival time list] "
		 << "[tpcutb] [tpcute] [time of scan start] [time of scan end] [nsigma] [list of sac file for scan] "
...
// write_sac_double("stackweak.sac",sacstackweak);
	...
	mean = getmean(sacstackweak->sacdata+realscnb, realscne-realscnb);
	...
	review_event(evt_detect_lst, n_evtdet, sacCC, sacevt, sacscn, n_comp, weak_nMAX);
